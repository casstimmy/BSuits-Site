...
export const portfolioStats = [
  ...
  { value: 'Web + Desktop + Mobile', label: 'deployment coverage' },
];
...
export const portfolioApps: PortfolioApp[] = [
  {
    ...
    deliveryMode: 'Web App, Windows Desktop & Mobile App',
    ...
    stack: 'Next.js, Windows Desktop build, Mobile App, MongoDB, Chart.js, PDF generation',
    status: 'Available on Web, Windows Desktop, and Mobile devices with central data sync',
    modules: [
    ...
    signals: ['Dashboard analytics', 'Stock and setup modules', 'Web + Desktop + Mobile'],
  ...
  },
  {
    ...
    stack: 'Next.js, Windows Desktop terminal, Mobile till, offline-aware UX',
    status: 'Available on Web, Windows Desktop, and Mobile devices with offline-ready caching',
    modules: [
    ...
    signals: ['PIN login UX', 'Menu and order tabs', 'Web + Desktop + Mobile'],
  ...
  },
  {
    ...
    deliveryMode: 'Web Storefront & Mobile Responsive',
    previewImage: '/images/Commerce Web Front preview.svg',
    icon: Store,
  ...
  },
  {
    ...
    stack: 'Next.js, Windows Desktop management suite, Mobile field app, MongoDB, cached dashboards',
    status: 'Available on Web, Windows Desktop, and Mobile devices for office and field workers',
    modules: [
    ...
    signals: ['Animal dashboard', 'Finance and inventory', 'Web + Desktop + Mobile'],
  ...
  },
  {
    ...
    previewImage: '/images/PDF Statement Extractor preview.svg',
    icon: FileText,
  ...
  },
  {
    ...
    deliveryMode: 'Web App, Windows Desktop & Mobile App',
    previewImage: '/images/Project Management Suite preview.svg',
    icon: FolderKanban,
    gradient: 'from-violet-600 to-fuchsia-600',
    summary:
      'Operations workspace spanning projects, budgets, emergency response, HSSE, incidents, maintenance, and work orders.',
    stack: 'Next.js, Windows Desktop suite, Mobile field app, MongoDB, gantt planning, role-based auth',
    status: 'Available on Web, Windows Desktop, and Mobile devices for project and facility operations',
    modules: [
    ...
    signals: ['Project and facility modules', 'Budget and incident workflows', 'Web + Desktop + Mobile'],
