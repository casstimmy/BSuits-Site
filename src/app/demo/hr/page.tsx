      ...
      <section className="pt-24 pb-10 gradient-bg-light">
        <div className="container-custom">
          <div className="flex items-center gap-3 text-sm text-dark-500 mb-6">
            ...
            <span>HR and Payroll Demo</span>
          </div>
          <SectionHeading
            badge="HR Demo"
            title="HR and payroll demo"
          ...
          <Card padding="lg" elevated>
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <h3 className="text-xl font-bold text-dark-900">HR and Payroll Demo Preview</h3>
              </div>
            </div>
            <div className="aspect-[16/10] rounded-2xl border border-dark-200 bg-white flex items-center justify-center">
              <div className="text-center px-6">
                <p className="text-sm font-semibold text-dark-900">HR and Payroll Preview</p>
